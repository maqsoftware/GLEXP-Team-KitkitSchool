...
import com.maq.xprize.kitkitlauncher.english.R;
        ...
        drum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tv.isUnlocked()) {
                    ...
                    try {
                        //Intent i = getPackageManager().getLaunchIntentForPackage("com.maq.xprize.drum");
                        ...
                        redirectToPlayStore("com.maq.xprize.drum");
                    }
...
//        marimba.setEnable(true);
        ...
        marimba.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tv.isUnlocked()) {
                    try {
                        //Intent i = getPackageManager().getLaunchIntentForPackage("com.maq.xprize.marimba");
                        Intent i = new Intent(Intent.ACTION_MAIN);
                        ...
                        redirectToPlayStore("com.maq.xprize.marimba");
                    }
            ...
            public void onClick(View v) {
                ...
                if (tv.isUnlocked()) {
                    try {
                        ...
                        //Intent i = getPackageManager().getLaunchIntentForPackage("com.maq.xprize.blackboard");
                        //startActivity(i);
                        KitKitLogger logger = ((LauncherApplication) getApplication()).getLogger();
                        logger.logEvent("ToolsActivity", "start_blackboard", "", 0);
                    } catch (Exception e) {
                        redirectToPlayStore("com.maq.xprize.blackboard");
                    }
                } else {
                    unlock(tv);
                }
            ...
            public void onClick(View v) {
                ...
                if (tv.isUnlocked()) {
                    ...
                    try {
                        ...
                        redirectToPlayStore("com.maq.xprize.drawingcoloring");
                    }
                } else {
                    unlock(tv);
                }
            ...
            public void onClick(View v) {
                ...
                if (tv.isUnlocked()) {
                    try {
                        ...
                        redirectToPlayStore("com.maq.xprize.xprize_gallery");
                    }
            ...
            public void onClick(View v) {
                ...
                if (tv.isUnlocked()) {
                    try {
                        ...
                        redirectToPlayStore("com.maq.xprize.FB");
                    }
                ...
                if (tv.isUnlocked()) {
                    if (gotoVideoPlayerForWritingBoard() == false) {
                        try {
                            ...
                            redirectToPlayStore("com.maq.xprize.writingboard");
                        }
                    }
